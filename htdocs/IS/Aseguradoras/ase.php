<?php
	...
	if($opcion[1] == 0){
		...
		$query="select * from aseguradora where rfc = '".$nombre[$indice]."'";
		$resultado = $mysqli->query($query);
		while($fila = $resultado->fetch_assoc()){
			$nom=utf8_encode($fila['nombre']);
			$rfc=$fila['rfc'];
			$rz=utf8_encode($fila['rz']);
	...
	<body>
		...
		<div class = 'medicamento-inputs' id= 'header'>
            ...
            <span>
             ...
             <br><br>
             <center>
             <a href='ConsultaAseguradoras.php'><input type='button' value='Regresar' class='btn-agregar'></a></center>
	...
	<form action = 'ActualizarAseguradora.php' type='submin' method = 'post' class = 'form-register'>
		...
		<div class = 'medicamento-inputs' id= 'header'>
            ...
            <span>
             ...
             <br><br>
             <a href='ConsultaAseguradoras.php'><input type='button' value='Regresar' class='btn-agregar'></a>
