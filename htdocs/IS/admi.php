<?php
	...
	if($opcion[1] == 0){
		...
		$query="select * from administrador where curp = '".$curp[$indice]."'";
...
<html lang = 'es'>
	...
	<body>
		...
		<h1 class=  'form-titulo'><b>Consultar administrador</b></h1>
		<br>
		...
		<div class = 'medicamento-inputs' id= 'header'>
            ...
            <span>
             ...
             <br><br>
             <center>
             <a href='ConsultaAdministradores.html'><input type='button' value='Regresar' class='btn-agregar'></a>
        	 </center>
        </div>
		</section>
	</body>
 ...
 //if(isset($_POST['agregar']) { 	
			...
			$insertar = "DELETE from administrador where curp = '".$curp[$indice]."'";
			...
			if(!$aber){
				...
				header('Refresh: 0.1; URL=ConsultaAdministradores.html');
