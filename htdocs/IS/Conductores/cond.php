<?php
	...
	if($opcion[1] == 0){
		...
		$query="select * from conductor where curp = '".$curp[$indice]."'";
...
<html lang = 'es'>
	<head>
		<meta charset = 'UTF-8'>
		<title>Consultar datos conductor</title> 
	...
	<body>
		...
		<h1 class=  'form-titulo'><b>Consultar datos conductor</b></h1>
		<br>
		...
		<div class = 'medicamento-inputs' id= 'header'>
            ...
            <span>
             ...
             <br><br>
             <center>
             <a href='ConsultaConductores.php'><input type='button' value='Regresar' class='btn-agregar'></a>
        	 </center>
        </div>
		</section>
	</body>
 ...
 //if(isset($_POST['agregar']) { 	
			...
			$insertar = "DELETE from conductor where curp = '".$curp[$indice]."'";
...
<html lang = 'es'>
	<head>
		<meta charset = 'UTF-8'>
		<title>Cambiar datos conductor</title> 
		<link rel='stylesheet' href = '../css/estilos.css'>
		<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css' /> 
        <script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js'></script>  
        <script src='https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js'></script>  
	...
	<body>
		...
		<h1 class=  'form-titulo'><b>Cambiar datos conductor</b></h1>
		<br>

	<form action = 'ActualizarConductor.php' type='submin' method = 'post' class = 'form-register'>
		<section>
		<div class = 'medicamento-inputs' id= 'header'>
			<span>
                <label class='input-48'>CURP</label><label class='input-48'>Nombre(s)</label><br>
