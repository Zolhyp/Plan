	...
	if($resultado->num_rows > 0){
		...
		while($fila = $resultado->fetch_assoc()){
			$salida.="<tr name='id' value='".$i."'>
                           ...
                           <td><input type='text' name = 'encargado[]' class='form-control name_list' style='width: 100%;' value = '".utf8_encode($fila['nombre'])." ".utf8_encode($fila['app'])." ".utf8_encode($fila['apm'])."' readonly='readonly'/></td>
