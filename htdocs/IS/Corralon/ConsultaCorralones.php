...
<html lang = "es">
	...
	<body>
		...
		<h1 class=  "form-titulo"><b>Consulta corralón</b></h1>
		<br>
		...
		<div class = "medicamento-inputs" id= "header">
			...
			<div class="form-1-2">
				<label for="caja_busqueda">Id de corralón</label><br>
				<input type="text" name="caja_busqueda" id="caja_busqueda" value = <?php echo $_SESSION['idCorralon'];?> readonly="readonly"></input>
			</div>
...
<br>
		...
		<script src="../js/maincorra.js"></script>
	</body>
</html>
