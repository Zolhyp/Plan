<?php
  ...
  if($_SESSION['nombre']) {
	...
	$salida="";
	$query="select curp, nombre, app, tel from conductor where idCorralon = '".$_SESSION['idCorralon']."'";
	if(isset($_POST['consulta'])){
		$q = $mysqli->real_escape_string($_POST['consulta']);
		$query ="select curp, nombre, app, tel from conductor where nombre like '%$q%' and idCorralon = '".$_SESSION['idCorralon']."'";
	}
